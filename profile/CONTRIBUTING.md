...
## 🧠 The "Brain-First" Policy (The AI Reality Check)
...
* **DON'T let it drive:** If you don't understand the code the AI gave you, **DON'T submit it.** We don't hire algorithms; we hire people who know how to use them. 

AI is a power tool, like a jackhammer—it’s great for breaking ground, but you wouldn't use it to perform surgery right? **Use your head first.**
...
3.  **The "Vibe" Test:** Before you submit a Pull Request, run the code. If it smokes the CPU but completes the task in record time, you’re on the right track.
...
### ✅ DO:
* **Prioritize Performance:** If you can save 2ms by writing a slightly "unreadable" bit of assembly, do it. We’ll hire someone to read it later.
...
3.  **Human vs. Tool ratio:** Tell us if this was 100% brain power or if you had to ask an LLM for a boost.
